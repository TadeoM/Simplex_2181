...
void MyRigidBody::SetModelMatrix(matrix4 a_m4ModelMatrix)
{
	...
	vector3 v3PointList[8];

	// the front points: starts from top right
	v3PointList[0] = vector3(m_v3MaxL.x, m_v3MaxL.y, m_v3MinL.z);
	v3PointList[1] = vector3(m_v3MaxL.x, m_v3MinL.y, m_v3MinL.z);
	v3PointList[2] = vector3(m_v3MinL.x, m_v3MinL.y, m_v3MinL.z);
	v3PointList[3] = vector3(m_v3MinL.x, m_v3MaxL.y, m_v3MinL.z);

	// the back points: starts from top rights
	v3PointList[4] = vector3(m_v3MaxL.x, m_v3MaxL.y, m_v3MaxL.z);
	v3PointList[5] = vector3(m_v3MaxL.x, m_v3MinL.y, m_v3MaxL.z);
	...
	for (uint i = 1; i < 8; ++i)
	{
		...
		{
			m_v3MaxG.x = v3PointList[i].x;
		}
		else if (m_v3MinG.x > v3PointList[i].x)
		{
			m_v3MinG.x = v3PointList[i].x;
		}

		if (m_v3MaxG.y < v3PointList[i].y)
		{
			m_v3MaxG.y = v3PointList[i].y;
		}
		else if (m_v3MinG.y > v3PointList[i].y)
		{
			m_v3MinG.y = v3PointList[i].y;
		}

		if (m_v3MaxG.z < v3PointList[i].z)
		{
			m_v3MaxG.z = v3PointList[i].z;
		}
		else if (m_v3MinG.z > v3PointList[i].z)
		{
			m_v3MinG.z = v3PointList[i].z;
		}
	}
